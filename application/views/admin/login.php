...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title><?php echo COMPANY?>| Login Options - Login Form </title>
        ...
        <link href="<?php echo base_url() ?>/theme/assets/admin/layout/css/themes/default.css" rel="stylesheet" type="text/css" id="style_color"/>
        ...
        <div class="logo">
            ...
            <div class="page-logo">
                <a href="<?php echo site_url('admin/dashboard'); ?>">
                    <img src="<?php echo base_url() ?>web_theme/images/logo.png" height="100"  alt=""/>
                </a>
            ...
            <div class="content">
                ...
                <![endif]-->
                <script src="<?php echo base_url() ?>/theme/assets/global/plugins/jquery.min.js" type="text/javascript"></script>
                <script src="<?php echo base_url() ?>/theme/assets/global/plugins/jquery-migrate.min.js" type="text/javascript"></script>
                ...
                <script src="<?php echo base_url() ?>/theme/assets/admin/pages/scripts/login.js" type="text/javascript"></script>
                <!-- END PAGE LEVEL SCRIPTS -->
                <script>
