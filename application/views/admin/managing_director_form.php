    ...
    <div class="col-md-12 ">
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption"><i class="fa fa-gift"></i>Managing Director's Message</div>                        
            </div>
            <div class="portlet-body form">
                <form id="basicForm" name="basicForm" action="<?php echo site_url('admin/managing_director/save') ?>" enctype="multipart/form-data" class="validate_form" method="post">
                            ...
                            <div  class="col-sm-6 input-group" id="list">
                                <?php if (isset($image) && !empty($image)) { ?>
                                    ...
                                    <div style="float: left; margin: 5px;" class="single_image_div">
                                        ...
                                        <img style="width: 100px;height:100px" src="<?php echo base_url() ?>uploads/managing_director/<?php echo $image ?>" alt="image">
    ...
    $(document).ready(function () {
        ...
        $('#images').change(function () {
            ...
            if (length >= 10) {
                ...
                $.ajax({
                    url: '<?php echo site_url('admin/managing_director/upload') ?>',
                    type: 'POST',
                    ...
                    success: function (res) {
                        ...
                        for (i = 0; i < Object.keys(res).length; i++) {
                            ...
                            var str = '<div class="single_image_div"><img  style="float: left; width: 100px; height: 100px;" src="<?php echo base_url() ?>uploads/managing_director/' + res[i] + '" title="' + res[i] + '"/><input type="hidden" name="temp_file" value="' + res[i] + '"></div>';
                            console.log(str);
                            $('#list').html(str);
